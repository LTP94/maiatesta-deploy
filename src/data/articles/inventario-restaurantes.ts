export const softwareInventarioRestaurantesQuito = {
  slug: 'software-inventario-restaurantes-quito' as const,
  ...
  primaryKeyword: 'software inventario restaurantes Quito',
  searchIntent:
    'Dueño o administrador de restaurante en Quito con pérdidas de insumos, compras sin control o stock que no cuadra con las ventas.',
  excerpt:
    'El inventario de un restaurante no funciona igual que el de una tienda. Los insumos son perecederos, las recetas usan ingredientes compartidos y la merma se acumula silenciosamente. Excel no alcanza para controlar todo eso.',
  sections: [
    {
      heading: 'Por qué el inventario de un restaurante es diferente al de una tienda',
      body: [
    ...
    {
      heading: 'Los problemas más comunes: merma oculta, compras sin control e insumos que desaparecen',
      body: [
    ...
    {
      heading: 'Qué debe tener un sistema de inventario para restaurante',
      body: [
    ...
    {
      heading: 'Diferencia entre un sistema genérico y uno adaptado a cocina',
      body: [
    ...
    {
      heading: 'Opciones disponibles y cuándo conviene un sistema a medida',
      body: [
    ...
    {
      heading: 'Por dónde empezar si hoy el inventario vive en Excel o en la memoria del encargado',
      body: [
  ...
  faqs: [
    {
      question: '¿Puedo usar un sistema de inventario de tienda para mi restaurante?',
      answer:
        'Puedes usarlo para controlar insumos básicos, pero si tu restaurante tiene recetas con múltiples ingredientes o necesitas descontar ingredientes automáticamente por plato, un sistema genérico de tienda quedará corto. Los restaurantes necesitan la lógica de recetas que los sistemas de retail no tienen.',
    },
    {
      question: '¿Cuánto se pierde por no controlar el inventario en un restaurante?',
      answer:
        'La merma en restaurantes sin control puede llegar a ser significativa, aunque el porcentaje exacto depende del tipo de negocio, el menú y los procesos internos. Sin datos propios del negocio, cualquier cifra sería una estimación no verificable. Lo que sí es claro es que sin control, no hay forma de saber cuánto se está perdiendo.',
    },
    {
      question: '¿Qué es una receta en un sistema de inventario?',
      answer:
        'En un sistema de inventario para restaurante, una receta es la definición de cuántos insumos se necesitan para preparar un plato. Cuando el sistema registra que se prepararon diez platos de ese tipo, descuenta automáticamente los ingredientes según la receta, sin necesidad de registrar cada ingrediente manualmente.',
    },
    {
      question: '¿Un sistema de inventario me ayuda con las compras a proveedores?',
      answer:
        'Sí, si el sistema tiene esa funcionalidad. Un buen sistema de inventario para restaurante puede generar alertas cuando los insumos llegan al nivel mínimo definido, lo que permite comprar en el momento correcto y con la cantidad adecuada, sin sobrestock ni faltantes.',
    },
    {
      question: '¿Cuánto cuesta implementar un sistema de inventario para un restaurante en Quito?',
      answer:
        'El costo varía según la solución elegida. Existen herramientas con suscripción mensual accesible y otras que requieren desarrollo a medida, con un costo inicial mayor pero adaptadas exactamente al proceso del negocio. La cotización depende del tamaño del restaurante, el número de bodegas, la complejidad del menú y los módulos necesarios.',
    },
  ],
  relatedServiceIds: ['inventory-software', 'custom-software', 'purchase-optimization', 'software-development-quito'],
  ctaMessage:
    'Hola Maiatesta, leí la guía de inventario para restaurantes en Quito y quiero revisar cómo controlar mejor mis insumos.',
};
