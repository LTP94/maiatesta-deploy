...
function getChannelIcon(label: string): JSX.Element | null {
  return CHANNEL_ICONS[label.toLowerCase()] ?? null;
}
      ...
      <div className="contact-copy scroll-reveal">
        ...
        <h2>
          <LuminousText
            ...
            phrases={contactHighlightPhrases}
          />
        </h2>
        ...
        <div className="contact-channels">
          {content.contact.channels.map((channel) => (
            <a
              href={channel.href}
              key={channel.label}
              data-channel={channel.label.toLowerCase()}
